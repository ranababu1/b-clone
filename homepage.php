  ...
  <div class="container">
    <div class="slider-container">
      <div class="slider-heading">
        <?php echo acf_html('slider_heading'); ?>
      </div>
      <div class="slider-content">
        <div class="slides">
          <?php for ($i = 1; $i <= 5; $i++): ?>
            <div class="slide">
              <img class="slider-thumbnail" alt="Slide <?php echo $i; ?> Thumbnail"
                   src="<?php echo acf_img_src("slide{$i}_leftimage", $fallback_img); ?>"
                   width="200" height="200" loading="lazy" />
              <div class="slide-content">
                <img alt="Slide <?php echo $i; ?> Logo"
                     src="<?php echo acf_img_src("slide{$i}_logo", $fallback_img); ?>"
                     width="100" height="18" loading="lazy" />
                <p><?php echo acf_html("slide{$i}_copy"); ?></p>
                <div class="cta-button"><?php echo acf_html("slide{$i}_cta_copy"); ?></div>
              </div>
              <a class="slider-overlay"
                 href="<?php echo acf_url("slide{$i}_cta_url"); ?>"
                 aria-label="<?php echo acf_html("slide{$i}_cta_copy"); ?>"></a>
            </div>
          <?php endfor; ?>
        </div>
      </div>
    ...
    <div class="slider-nav">
      <?php for ($i = 1; $i <= 5; $i++): ?>
        <button class="nav-btn <?php echo $i === 1 ? 'active' : ''; ?>" data-index="<?php echo $i - 1; ?>">
          <img alt="tab <?php echo $i; ?>"
               src="<?php echo acf_img_src("tab_image_{$i}", $fallback_img); ?>"
               width="100" height="18" loading="lazy" />
        </button>
      <?php endfor; ?>
    </div>
